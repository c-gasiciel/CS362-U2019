...
* * DESCRIPTION:    Random test for Tribute card functionality updated to
* *                 work with classmate code
******************************************************************************/
#include "dominion.h"
...
void checkTribute(struct gameState *post, int nextPlayer, int currPlayer)
{
  ...
  int postTributeRevealedCards[2] = {-1, -1};
  ...
  do_tribute(post, postTributeRevealedCards, nextPlayer, currPlayer);
